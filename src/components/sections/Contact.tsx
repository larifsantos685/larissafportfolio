      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-slate-400 max-w-xl mx-auto">
            Tem alguma ideia, projeto ou oportunidade? Preencha o formulário
            abaixo ou me chame nas redes.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto items-start">
            ...
            <Card className="bg-slate-900/50 border-slate-800 p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:larissafsantos.685@gmail.com"
            ...
            <Card className="bg-slate-900/50 border-slate-800 p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <a
                    href="https://www.linkedin.com/in/larissafsantos685/"
                    target="_blank"
                    className="text-slate-400 hover:text-indigo-400 transition-colors"
                  >
                    in/larissfsantos685
            ...
            <Card className="bg-slate-900/50 border-slate-800 p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <a
                    href="https://github.com/larifsantos685"
                    target="_blank"
                    className="text-slate-400 hover:text-indigo-400 transition-colors"
                  >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="order-1 md:order-two"
          >
